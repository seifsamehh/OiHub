    ...
    exit={{opacity: 0, x: "100vw", scale: 1.2, transition: {duration : 1, type: "tween", ease: "anticipate"}}}>
        ...
        <div className="right">
            <div className="information" data-aos="fade-down-left" data-aos-duration="1000">
                <p>We provide trainning in C++ and make you qualify to ACM ICPC around all season.</p>
                <Link to="/CpcTeam" className="button button--greip"><span><span>MORE</span></span></Link>
            </div>
        </div>
    </motion.section>
  )
